...
const ShareTip = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const tagsArray = rawFormData.get('tags')
            .split(',')
            .map(tag => tag.trim())
            .filter(tag => tag !== '');
        ...
        const tipData = {
            ...
            tags: tagsArray,
            user: {
                name: currentUser?.displayName || 'Anonymous Gardener',
                            ...
                            <div className="flex items-center">
                                <div className="avatar mr-3">
                                    <div className="w-10 h-10 rounded-full bg-base-100 overflow-hidden">
                                        <img
                                            src={currentUser?.photoURL || 'https://i.postimg.cc/VsJzs7By/Tonmoy-Sarker.jpg'}
                                            alt="User Avatar"
